# Demo video script, EARLIER DIRECTION (superseded)

> This script records the ERC-8183 escrow referee, which is no longer the product Referi
> submits. It is kept because that work is real and still runs (`make demo`). The script for
> the submission take is `demo/video-script.md`.

## Original header (TAKE-1)
